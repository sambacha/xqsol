...
declare function e:notation() as element()
{
  <table border="0" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <tr><td><pre><a name="_Choice">Choice</a></pre></td><td><pre> ::= </pre></td><td><pre><a href="#_SequenceOrDifference">SequenceOrDifference</a> ( '|' <a href="#_SequenceOrDifference">SequenceOrDifference</a> )*</pre></td><td>&#xA;</td></tr>
    <tr><td><pre><a name="_SequenceOrDifference">SequenceOrDifference</a></pre></td><td><pre> ::= </pre></td><td><pre>(<a href="#_Item">Item</a> ( '-' <a href="#_Item">Item</a> | <a href="#_Item">Item</a>* ))?</pre></td><td>&#xA;</td></tr>
